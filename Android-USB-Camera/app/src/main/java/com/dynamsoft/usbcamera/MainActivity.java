...
//                    Toast.makeText(TestActivity.this, "Cancelled", Toast.LENGTH_LONG).show();
//                } else {
//                    Toast.makeText(TestActivity.this, "Scanned: " + result.getBarcodeText(), Toast.LENGTH_LONG).show();
//                }
//            });
